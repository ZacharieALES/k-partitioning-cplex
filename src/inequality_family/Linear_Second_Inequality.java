 ...
 *
 */
public class Linear_Second_Inequality extends Abstract_Inequality{

	public int i,j;
	
	public Linear_Second_Inequality(Solution_Representative s, int i, int j) {
		super(s);
		if(i < j){
			this.i = i;
			this.j = j;
	...
	public Abstract_Inequality clone() {
		return new Linear_Second_Inequality(s, i, j);
	}
