...
public class TriangleInequalityXY2 extends AbstractInequality<IFEdgeVNodeClusterV>{

	public int s1;
	public int t1, t2;

	public TriangleInequalityXY2(IFEdgeVNodeClusterV formulation, int s1, int t1, int t2) {
	...
	public AbstractInequality<IFEdgeVNodeClusterV> clone() {
		...
		return new TriangleInequalityXY2(formulation, s1, t1, t2);
