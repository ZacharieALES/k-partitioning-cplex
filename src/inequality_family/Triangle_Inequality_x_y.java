 ...
 *
 */
public class Triangle_Inequality_x_y extends Abstract_Inequality{

	public int s1;
	public int t1, t2;
	
	public Triangle_Inequality_x_y(Solution_Representative s, int s1, int t1, int t2) {
		super(s);
		this.s1 = s1;
		this.t1 = t1;
		this.t2 = t2;
	...
	public Abstract_Inequality clone() {
		...
		return new Triangle_Inequality_x_y(s, s1, t1, t2);
	}

	@Override
	public double evaluate() throws IloException  {

		double result = this.s.y(s1, t1);
		result += s.y(s1, t2);
		result -= s.x(t1, t2);
