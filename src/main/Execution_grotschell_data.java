...
public class Execution_grotschell_data {
	...
	public void solve(){
		TildeParam tp = new TildeParam("./data/grotschell/n_158_v1.txt", 7, true, Triangle.USE_LAZY_IN_BC_ONLY, true, false, false);
		tp.isInt = false;
//		Partition_with_tildes p = new Partition_with_tildes(4, "./data/grotschell/n_34_v1.txt", new CplexParam(false), new TildeParam(false, true, true, false, true, false, false));
		...
		CP_Rep cprep = new CP_Rep(tp, 500, 300,  -1, 750, true, 3600);
		cprep.solve();
