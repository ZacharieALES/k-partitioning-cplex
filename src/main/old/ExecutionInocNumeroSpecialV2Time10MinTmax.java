...
public class ExecutionInocNumeroSpecialV2Time10MinTmax extends Execution{
	...
	TildeParam tp  = new TildeParam(null, cplex, -1, true, Triangle.USE, true, true, true);
	RepParam rp = new RepParam(null, cplex, -1, Triangle.USE, true, true, true);
	XYParam xy1p = new XYParam(null, cplex, -1, false, false);
	XYParam xy2p = new XYParam(null, cplex, -1, true, false);
	...
	public ExecutionInocNumeroSpecialV2Time10MinTmax(Cplex cplex, int nm, int nM2, int km, int kM2,
			int im, int iM2) {
	...
	public void performFormulation(int id_n, int id_k, int id_i, int gap, int formulation, String formulation_name){
		...
		try {
			if(resultats[id_n][id_k][gap][formulation][0][id_i] == -Double.MAX_VALUE
				...
				resultats[id_n][id_k][gap][formulation][1][id_i] = p.getCplex().solve();
				resultats[id_n][id_k][gap][formulation][2][id_i] = p.getCplex().getNnodes();
				resultats[id_n][id_k][gap][formulation][0][id_i] = p.getCplex().getBestObjValue();
				resultats[id_n][id_k][gap][formulation][3][id_i] = p.getCplex().getObjValue();
	...
	public static void main(String[] args){
		...
		ExecutionInocNumeroSpecialV2Time10MinTmax expe = new ExecutionInocNumeroSpecialV2Time10MinTmax(new Cplex(), 0, 0, 0, 0, 0, 0);
