...
public class ExecutionRootRelaxation extends Execution{
...
//	double[][][] kp1Root = ComputeResults.unserialize(pre + "kp1"  + suf);
	...
	public ExecutionRootRelaxation(Cplex cplex, int nm, int nM2, int km, int kM2, int im,
			int iM2) {
	...
	public void execution() throws IloException {
		...
		RepParam param = new RepParam(null, cplex, -1, false);
		param.isInt = false;
...
//			
//			rep = ((PartitionWithRepresentative)createPartition(new CplexParam(true, false, false, cplex, -1), param));
...
//			tccRoot[c_n][c_k][c_i][i] = rr_improved(rep, new Separation_TCC_Muller_Improvement(rep));
			...
			triangleRepRoot[c_n][c_k][c_i][i] = rr_improved(rep, new SeparationPawInequalitiesExhaustive(rep, rep.variableGetter()));
...
//		ComputeResults.serialize(triangleRepRoot, prefix + "new2");
	...
	public double rr_improved(Partition rep, AbstractSeparation sep) throws IloException{
		...
		while(found){
			...
			found = false;
			ArrayList<AbstractInequality> al_ineq;
				al_ineq = sep.separate();
				if(al_ineq.size() > 0){
					for(AbstractInequality ineq : al_ineq){
	...
	public double rr_improved_exhaustif(Partition rep, AbstractSeparation<? extends IFormulation> sep) throws IloException{
		
		rep.getCplex().solve();
		
		ArrayList<AbstractInequality<? extends IFormulation>> al_ineq;
			al_ineq = sep.separate();
			if(al_ineq.size() > 0){
	...
	public void isIntResults(){
		...
		double[][][][] root_0_to_19 = ComputeResults.unserialize(prefix + "rr_4d_root_i_min0_i_max19", double[][][][].class);
...
//	System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-chorded cycles sur 100 graphes complets dont le poids des arêtes est positif.");
...
//		prefix2 += "\\backslashbox{$n$}{$K$} & 2& 3& 4& 5& 6& 7& 8& 9& 10\\\\\\midrule\n";
		...
		ComputeResults.printDoubleTable(tab1, true);
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-partition sur 100 graphes complets dont le poids des arêtes est positif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab1, true);
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de clique généralisées sur 100 graphes complets dont le poids des arêtes est positif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab1, true);
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de triangles représentatifs sur 100 graphes complets dont le poids des arêtes est positif.");
		System.out.println(suffix2);
		...
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-chorded cycle sur 100 graphes complets dont le poids des arêtes peut\\^etre positif ou négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab2, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-partition sur 100 graphes complets dont le poids des arêtes peut \\^etre positif ou négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab2, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de clique généralisées sur 100 graphes complets dont le poids des arêtes peut \\^etre positif ou négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab2, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités triangulaire représentatifs sur 100 graphes complets dont le poids des arêtes peut \\^etre positif ou négatif.");
		System.out.println(suffix2);
		...
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de clique généralisées sur 100 graphes complets dont le poids des arêtes est négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab3, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-partition sur 100 graphes complets dont le poids des arêtes est négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab3, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités de $2$-chorded cycle sur 100 graphes complets dont le poids des arêtes est négatif.");
		System.out.println(suffix2);
		...
		ComputeResults.printDoubleTable(tab3, true);System.out.println("\n");
		System.out.println(suffix1);
		System.out.println("Amélioration moyenne de la relaxation linéaire par utilisation d'inégalités triangulaire représentatifs sur 100 graphes complets dont le poids des arêtes est négatif.");
		System.out.println(suffix2);
