...
public class ExecutionInocNumeroSpecialTsp extends Execution{
	...
	public ExecutionInocNumeroSpecialTsp(Cplex cplex){
		...
		try {
			...
			if(resultats[id_k][formulation][instance][0] == -Double.MAX_VALUE
				...
				if( formulation < 4 ){
					...
					case 1 : 
						xy1p.KMax = k;
						p = new PartitionXY(xy1p);
						break;
					case 2 : 
						xy2p.KMax = k;
						p = new PartitionXY2(xy2p);
						break;
					case 3 : 
						tp.KMax = k;
