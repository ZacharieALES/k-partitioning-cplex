 ...
 *
 */
public class ExecutionEvaluationRatioKL extends Execution{

	double[][][] results;
	
	public ExecutionEvaluationRatioKL(Cplex cplex, int nm, int nM2, int km, int kM2, int im,
			int iM2) {
...
//			/* Cutting Plane */
//			PartitionWithRepresentative rep = createPartition(new CplexParam(false, true, false, cplex, -1), new TildeParam(false, false, false, true, true, false, false));
