...
public class ExecutionNn1 extends Execution{

	public ExecutionNn1(Cplex cplex, int nm, int nM2, int km, int kM2, int im,
			int iM2) {
	...
	public void execution() throws IloException {
			...
			results[c_n][c_k][c_i][0] = this.getRootRelaxation(new TildeParam(null, cplex, -1, true, Triangle.USE_LAZY_IN_BC_ONLY, true, true, true));
			results[c_n][c_k][c_i][1] = this.getRootRelaxation(new TildeParam(null, cplex, -1, false, Triangle.USE_LAZY_IN_BC_ONLY, true, true, true));
