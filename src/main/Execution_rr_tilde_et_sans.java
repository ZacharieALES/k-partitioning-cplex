...
public class Execution_rr_tilde_et_sans extends Execution{

	public Execution_rr_tilde_et_sans() {
		super(15, 20, 2, 6, 0, 99);
...
//		rep.solve();
//		switch(i){
//			case 0: res_tildes1[c_n][c_k][c_i] = rep.getObjValue2();break;
//			case 1: res_tildes2[c_n][c_k][c_i] = rep.getObjValue2();break;
//			case 2: res_tildes3[c_n][c_k][c_i] = rep.getObjValue2();break;
//		}
//		
//		
//		double v0 = rep.getObjValue2();
//		
//		rep = ((PartitionWithRepresentative)createPartition(new CplexParam(false), rp));
//		rep.solve();
//		switch(i){
//			case 0: res_ss_tildes1[c_n][c_k][c_i] = rep.getObjValue2();break;
//			case 1: res_ss_tildes2[c_n][c_k][c_i] = rep.getObjValue2();break;
//			case 2: res_ss_tildes3[c_n][c_k][c_i] = rep.getObjValue2();break;
//		}	
//
//////		double v15 = rep.getObjValue2();
//////
////		xyp.isSecondXYFormulation= false;
