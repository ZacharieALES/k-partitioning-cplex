 ...
 *
 */
public class Execution_sub_rep_added_when_branching extends Execution{
	...
	public Execution_sub_rep_added_when_branching(int nbOfGraphs) {
		super(20, 50, 2, 10, 0, nbOfGraphs);
			...
			for(int i = 0 ; i < gapValues.size() ; ++i){
				...
				try {
					...
					if(resultsWithoutSubRep[id_n][c_k][c_i][i][0] == -Double.MAX_VALUE
						...
						resultsWithoutSubRep[id_n][c_k][c_i][i][2] = rep.getObjValue2();
						resultsWithoutSubRep[id_n][c_k][c_i][i][3] = rep.getNnodes();
					}
...
//						PartitionWithRepresentative.cplex.use(new CB_AddSubRep_inequalities(rep));
						...
						PartitionWithRepresentative.cplex.use(new Separation_SubRepresentative_sans_doublon(rep).createDefaultCallback(rep));
						resultsWithSubRep[id_n][c_k][c_i][i][0] = rep.solve();
						resultsWithSubRep[id_n][c_k][c_i][i][1] = rep.getBestObjValue2();
						resultsWithSubRep[id_n][c_k][c_i][i][2] = rep.getObjValue2();
						resultsWithSubRep[id_n][c_k][c_i][i][3] = rep.getNnodes();
						resultsWithSubRep[id_n][c_k][c_i][i][4] = CB_AddSubRep_inequalities.addedInequalities;
						CB_AddSubRep_inequalities.addedInequalities = 0;
					}
...
//						
//						
//						resultsWithInitialSubRep[id_n][c_k][c_i][i][0] = rep.solve();
//						resultsWithInitialSubRep[id_n][c_k][c_i][i][1] = rep.getBestObjValue2();
//						resultsWithInitialSubRep[id_n][c_k][c_i][i][2] = rep.getObjValue2();
//						resultsWithInitialSubRep[id_n][c_k][c_i][i][3] = rep.getNnodes();
//					}
