 ...
 *
 */
public class Separation_Kp1_Dense_heuristic extends Abstract_Separation{
	...
	public Separation_Kp1_Dense_heuristic(Solution_Representative rep){
		super("Kp1_dense_heuristic", rep);
		
		int t = (int) Math.ceil(rep.n()/rep.K())+2;
