		...
		if(this.getNodeData() instanceof NodeInfo){
			...
			if(ni.currentNode == 2){
				...
				if(new_ni.nbRepTo1 == rep.KMax()){
					...
					c_range[1] = rep.getCplex().range(0.0, expr13, 0.0);
					
					/* x23 = 0 */
					IloLinearNumExpr expr23 = rep.getCplex().linearNumExpr();
					expr13.addTerm(1.0,rep.v_edge[2][1]);
					c_range[2] = rep.getCplex().range(0.0, expr23, 0.0);
...
//System.out.println("Last node to 1 : " + ni.lastNodeTo1 +"\n--------");
	...
	public IloRange x3Eq1() throws IloException{
		return rep.getCplex().range(3.0-rep.KMax(), exprX3(), 3.0-rep.KMax());
	}
	...
	public IloRange x3Eq0() throws IloException{
		return rep.getCplex().range(2.0-rep.KMax(), exprX3(), 2.0-rep.KMax());
	}
	...
	public IloRange x2Eq1() throws IloException{
		return rep.getCplex().range(0.0, exprX2(), 0.0);
	}
	...
	public IloRange x2Eq0() throws IloException{
		return rep.getCplex().range(1.0, exprX2(), 1.0);
	}
